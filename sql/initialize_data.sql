...
(1, DATE_SUB(CURRENT_DATE, INTERVAL 10 DAY), 1200.00),  
(1, DATE_SUB(CURRENT_DATE, INTERVAL 25 DAY), 800.00),   
(1, DATE_SUB(CURRENT_DATE, INTERVAL 40 DAY), 600.00),
(6, DATE_SUB(CURRENT_DATE, INTERVAL 15 DAY), 1500.00),  
(6, DATE_SUB(CURRENT_DATE, INTERVAL 30 DAY), 900.00),

-- Loyal customers: Recent + frequent (Segment 1)
(2, DATE_SUB(CURRENT_DATE, INTERVAL 5 DAY), 200.00),   
(2, DATE_SUB(CURRENT_DATE, INTERVAL 20 DAY), 150.00),  
(2, DATE_SUB(CURRENT_DATE, INTERVAL 35 DAY), 100.00),
(4, DATE_SUB(CURRENT_DATE, INTERVAL 8 DAY), 300.00),   
(4, DATE_SUB(CURRENT_DATE, INTERVAL 22 DAY), 250.00),  

-- New customers: Recent but lower frequency (Segment 2)
(3, DATE_SUB(CURRENT_DATE, INTERVAL 12 DAY), 150.00),  
(5, DATE_SUB(CURRENT_DATE, INTERVAL 18 DAY), 180.00),    
(7, DATE_SUB(CURRENT_DATE, INTERVAL 3 DAY), 120.00),   

-- At-Risk customers: Medium recency, declining activity (Segment 3)
(8, DATE_SUB(CURRENT_DATE, INTERVAL 100 DAY), 200.00),   
(8, DATE_SUB(CURRENT_DATE, INTERVAL 120 DAY), 150.00),   
(9, DATE_SUB(CURRENT_DATE, INTERVAL 95 DAY), 300.00),   
(10, DATE_SUB(CURRENT_DATE, INTERVAL 110 DAY), 250.00),  

-- Churned customers: Old orders, no recent activity (Segment 4)
(11, DATE_SUB(CURRENT_DATE, INTERVAL 250 DAY), 100.00), 
(12, DATE_SUB(CURRENT_DATE, INTERVAL 280 DAY), 200.00),  
(13, DATE_SUB(CURRENT_DATE, INTERVAL 300 DAY), 150.00), 
(14, DATE_SUB(CURRENT_DATE, INTERVAL 320 DAY), 180.00), 
(15, DATE_SUB(CURRENT_DATE, INTERVAL 350 DAY), 120.00);  
